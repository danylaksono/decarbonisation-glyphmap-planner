if (typeof L !== "undefined") {
   ...
   * This allows for efficient rendering of many points on a canvas
   * rather than using individual markers
   */
  ...
  L.CanvasLayer = L.Layer.extend({
    ...
    _animateZoom: function (e) {
      ...
      var newCenter = map._latLngToNewLayerPoint(
        map.getCenter(),
        e.zoom,
        e.center
      );
      ...
      bg.style[transform] =
        L.DomUtil.getTranslateString(origin) + " scale(" + e.scale + ") ";
    },
    ...
    _render: function () {
      ...
      this.currentAnimationFrame = this.requestAnimationFrame.call(
        window,
        this.render
      );
    },
    ...
    render: function () {
      // Implement in child class or when instantiating
