export const tileDictionary = {
  ...
  "Carto Positron Light NoLabel": {
    ...
    options: {
      attribution:
        '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a>',
      subdomains: "abcd",
      maxZoom: 20,
    },
  },
  ...
  "Strava All": {
    url: "https://heatmap-external-b.strava.com/tiles/all/bluered/{z}/{x}/{y}.png",
  },
  "Strava Run": {
    url: "https://heatmap-external-b.strava.com/tiles/run/bluered/{z}/{x}/{y}.png?v=19",
  },
  "Open Weather Map Temperature": {
    url: "http://tile.openweathermap.org/map/temp_new/{z}/{x}/{y}.png?APPID=1c3e4ef8e25596946ee1f3846b53218a",
  },
  ...
  "Open Weather Map Wind Speed": {
    url: "http://tile.openweathermap.org/map/wind_new/{z}/{x}/{y}.png?APPID=f9d0069aa69438d52276ae25c1ee9893",
  },
  "Bing VirtualEarth": {
